...
d = Excerpt.new({"text"=>"I would give up the unessential; I would give up my money, I would give up my life for my children; but I wouldn''t give myself. I can''t make it more clear; it''s only something I am beginning to comprehend, which is revealing itself to me.", "source"=>"The Awakening", "person_id"=>"8"})




b = Excerpt.new({"text"=>"How many girls stay awake all night<br>too scared to sleep and too scared to fight back<br>I know you know what I''m talking about<br>another woman killed and hardly a pout about it<br>green river killer my f**king a**<br>the cops have gotta be deaf, dumb, and spastic<br>to not catch the killer(s) of one hundred women<br>I guess it''d be different if they thought we were human<br><br>I wanna know what love is.", "source"=>"\"I Wanna Know What Love Is\"", "person_id"=>"21"}) #julie ruin
c = Excerpt.new({"text"=>"Rape us and beat us ''til we''re black and blue<br>We made it ok on the day we said nothing<br>Was better than something to say<br><br>What our foremothers fought for was peachy and swell<br>But hey they forgot to be mothers as well<br>Instead of our fathers, our sisters did say:Let''s just be pretty, it''s more fun that way<br><br>Let''s just be pretty<br>Let''s just be beautiful<br>Let''s just be retro and disco and twee<br>We don''t know the song so we can''t sing along<br>And our daughters will never be free.", "source"=>"Our Daughters Will Never Be Free", "person_id"=>"22"}) #the indelicates
e = Excerpt.new({"text"=>"", "source"=>"", "person_id"=>""})

EX = Excerpt.new({"text"=>"", "source"=>"", "person_id"=>""})
...
c = Quote.new({"text"=>"Though we have the courage to raise our daughters more like our sons, we''ve rarely had the courage to raise our sons more like our daughters.", "person_id"=>"6"})
d = Quote.new({"text"=>"We cannot all succeed when half of us are held back.", "person_id"=>"7"})


f = Quote.new("text"=>"I am not free while any woman is unfree, even when her shackles are very different from my own.", "person_id"=>"8"}) #audre lorde
g = Quote.new({"text"=>"As soon as a woman gets to an age where she has opinions and she''s vital and she''s strong, she''s systematically shamed into hiding under a rock.", "person_id"=>"11"}) #sarah silverman
h = Quote.new({"text"=>"For most of history, \"Anonymous\" was a woman.", "person_id"=>"12"}) #virginia woolf


EX = Quote.new({"text"=>"", "person_id"=>""})
...
# r = Person.new({"name"=>"Dolores Huerta", "bio"=>"Dolores Huerta is a union leader and an activist for the rights of farm workers and women. Along with Cesar Chavez, she founded the first successful farm workers union in the country, the United Farm Workers, in 1962. She is a recipient of the Presidential Medal of Freedom.<br><br>Huerta was born in New Mexico in 1930, where her father was a union activist and state legislator. Following her parents divorce, Dolores moved with her mother to California’s farm-filled San Joaquin Valley. <br><br>She was inspired to fight for workers rights when, as a young school teacher, she noticed that many of her students were showing up to school ill or malnourished. She founded the Agricultural Workers Association in 1960 and used the organization to lobby politicians on a variety of issues pertaining to the rights of migrant workers. She left the AWA just two years later, when she and Cesar Chavez founded what would come to be known as the United Farm Workers union.<br><br>Often she risked life and limb in order to ensure the rights of farm workers — in 1988, a San Francisco police officer beat her so badly that she was left with several broken ribs and a ruptured spleen.<br><br> Huerta has since stepped down from her position at the UFW, but she continues to lecture on worker’s issues and women’s issues around the country. In addition to the Presidential Medal of Freedom, she has received numerous awards and recognitions—among them the Eleanor Roosevelt Humans Rights Award from President Clinton in l998, the Ohtli award from the Mexican Government, and nine honorary doctorates from Universities throughout the United States.", "state"=>"New Mexico", "country"=>"United States", "image"=>"http://upload.wikimedia.org/wikipedia/commons/thumb/c/c6/Dolores_Huerta.jpg/303px-Dolores_Huerta.jpg", "caption"=>"Photo by <a href=\"http://www.flickr.com/photos/33977223@N08/3584728514\">Eric Guo</a>", "source"=>"<a href=\"http://www.makers.com/dolores-huerta\">PBS</a>"})



h = Person.new({"name"=>"Audre Lorde", "bio"=>"", "state"=>"", "country"=>"", "image"=>"", "caption"=>"", "source"=>""})
i = Person.new({"name"=>"Lupita Nyong''o", "bio"=>"", "state"=>"", "country"=>"", "image"=>"", "caption"=>"", "source"=>""})
k = Person.new({"name"=>"Sarah Silverman", "bio"=>"", "state"=>"", "country"=>"", "image"=>"", "caption"=>"", "source"=>""})
l = Person.new({"name"=>"Virginia Woolf", "bio"=>"", "state"=>"", "country"=>"", "image"=>"", "caption"=>"", "source"=>""})
m = Person.new({"name"=>"Amy Poehler", "bio"=>"", "state"=>"", "country"=>"", "image"=>"", "caption"=>"", "source"=>""})
n = Person.new({"name"=>"Alberta Williams King", "bio"=>"", "state"=>"", "country"=>"", "image"=>"", "caption"=>"", "source"=>""})
o = Person.new({"name"=>"Kirsten Gillibrand", "bio"=>"", "state"=>"", "country"=>"", "image"=>"", "caption"=>"", "source"=>""})
q = Person.new({"name"=>"Fannie Lou Hamer", "bio"=>"", "state"=>"", "country"=>"", "image"=>"", "caption"=>"", "source"=>""})
s = Person.new({"name"=>"Christine de Pizan", "bio"=>"", "state"=>"", "country"=>"", "image"=>"", "caption"=>"", "source"=>""})
t = Person.new({"name"=>"Juana Inés de la Cruz", "bio"=>"", "state"=>"", "country"=>"", "image"=>"", "caption"=>"", "source"=>""})
v = Person.new({"name"=>"Julie Ruin", "bio"=>"", "state"=>"", "country"=>"", "image"=>"", "caption"=>"", "source"=>""})
w = Person.new({"name"=>"The Indelicates", "bio"=>"", "state"=>"", "country"=>"", "image"=>"", "caption"=>"", "source"=>""})

EX = Person.new("name"=>"", "bio"=>"", "state"=>"", "country"=>"", "image"=>"", "caption"=>"", "source"=>""})

matches:

a = KeywordItem.new({"keyword_id"=>"", "item_id"=>"", "item_table_id"=>""})
b = KeywordItem.new({"keyword_id"=>"", "item_id"=>"", "item_table_id"=>""})
c = KeywordItem.new({"keyword_id"=>"", "item_id"=>"", "item_table_id"=>""})
d = KeywordItem.new({"keyword_id"=>"", "item_id"=>"", "item_table_id"=>""})
e = KeywordItem.new({"keyword_id"=>"", "item_id"=>"", "item_table_id"=>""})
f = KeywordItem.new({"keyword_id"=>"", "item_id"=>"", "item_table_id"=>""})
g = KeywordItem.new({"keyword_id"=>"", "item_id"=>"", "item_table_id"=>""})
h = KeywordItem.new({"keyword_id"=>"", "item_id"=>"", "item_table_id"=>""})
i = KeywordItem.new({"keyword_id"=>"", "item_id"=>"", "item_table_id"=>""})
j = KeywordItem.new({"keyword_id"=>"", "item_id"=>"", "item_table_id"=>""})
k = KeywordItem.new({"keyword_id"=>"", "item_id"=>"", "item_table_id"=>""})
l = KeywordItem.new({"keyword_id"=>"", "item_id"=>"", "item_table_id"=>""})
m = KeywordItem.new({"keyword_id"=>"", "item_id"=>"", "item_table_id"=>""})
n = KeywordItem.new({"keyword_id"=>"", "item_id"=>"", "item_table_id"=>""})
o = KeywordItem.new({"keyword_id"=>"", "item_id"=>"", "item_table_id"=>""})
p = KeywordItem.new({"keyword_id"=>"", "item_id"=>"", "item_table_id"=>""})
q = KeywordItem.new({"keyword_id"=>"", "item_id"=>"", "item_table_id"=>""})
r = KeywordItem.new({"keyword_id"=>"", "item_id"=>"", "item_table_id"=>""})
s = KeywordItem.new({"keyword_id"=>"", "item_id"=>"", "item_table_id"=>""})
t = KeywordItem.new({"keyword_id"=>"", "item_id"=>"", "item_table_id"=>""})
u = KeywordItem.new({"keyword_id"=>"", "item_id"=>"", "item_table_id"=>""})
v = KeywordItem.new({"keyword_id"=>"", "item_id"=>"", "item_table_id"=>""})
w = KeywordItem.new({"keyword_id"=>"", "item_id"=>"", "item_table_id"=>""})
x = KeywordItem.new({"keyword_id"=>"", "item_id"=>"", "item_table_id"=>""})
y = KeywordItem.new({"keyword_id"=>"", "item_id"=>"", "item_table_id"=>""})
z = KeywordItem.new({"keyword_id"=>"", "item_id"=>"", "item_table_id"=>""})
aa = KeywordItem.new({"keyword_id"=>"", "item_id"=>"", "item_table_id"=>""})
bb = KeywordItem.new({"keyword_id"=>"", "item_id"=>"", "item_table_id"=>""})
cc = KeywordItem.new({"keyword_id"=>"", "item_id"=>"", "item_table_id"=>""})
dd = KeywordItem.new({"keyword_id"=>"", "item_id"=>"", "item_table_id"=>""})
ee = KeywordItem.new({"keyword_id"=>"", "item_id"=>"", "item_table_id"=>""})
ff = KeywordItem.new({"keyword_id"=>"", "item_id"=>"", "item_table_id"=>""})
gg = KeywordItem.new({"keyword_id"=>"", "item_id"=>"", "item_table_id"=>""})
hh = KeywordItem.new({"keyword_id"=>"", "item_id"=>"", "item_table_id"=>""})
ii = KeywordItem.new({"keyword_id"=>"", "item_id"=>"", "item_table_id"=>""})
jj = KeywordItem.new({"keyword_id"=>"", "item_id"=>"", "item_table_id"=>""})
kk = KeywordItem.new({"keyword_id"=>"", "item_id"=>"", "item_table_id"=>""})
ll = KeywordItem.new({"keyword_id"=>"", "item_id"=>"", "item_table_id"=>""})
mm = KeywordItem.new({"keyword_id"=>"", "item_id"=>"", "item_table_id"=>""})
nn = KeywordItem.new({"keyword_id"=>"", "item_id"=>"", "item_table_id"=>""})
oo = KeywordItem.new({"keyword_id"=>"", "item_id"=>"", "item_table_id"=>""})
pp = KeywordItem.new({"keyword_id"=>"", "item_id"=>"", "item_table_id"=>""})
qq = KeywordItem.new({"keyword_id"=>"", "item_id"=>"", "item_table_id"=>""})
rr = KeywordItem.new({"keyword_id"=>"", "item_id"=>"", "item_table_id"=>""})
ss = KeywordItem.new({"keyword_id"=>"", "item_id"=>"", "item_table_id"=>""})
tt = KeywordItem.new({"keyword_id"=>"", "item_id"=>"", "item_table_id"=>""})
uu = KeywordItem.new({"keyword_id"=>"", "item_id"=>"", "item_table_id"=>""})
vv = KeywordItem.new({"keyword_id"=>"", "item_id"=>"", "item_table_id"=>""})
ww = KeywordItem.new({"keyword_id"=>"", "item_id"=>"", "item_table_id"=>""})
xx = KeywordItem.new({"keyword_id"=>"", "item_id"=>"", "item_table_id"=>""})
yy = KeywordItem.new({"keyword_id"=>"", "item_id"=>"", "item_table_id"=>""})
zz = KeywordItem.new({"keyword_id"=>"", "item_id"=>"", "item_table_id"=>""})
