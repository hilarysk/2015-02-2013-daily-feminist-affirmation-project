...
DATABASE = SQLite3::Database.new("/Users/hilarysk/Code/2015-02-13-daily-feminist-affirmation-project/tests/feminist_affirmation_test.db")
...
class DailyFemAffirm < Minitest::Test
  ...
  def test_insert
    ...
    term1 = Term.new({"term"=>"Intersectional feminism", "definition"=>"A key component of third-wave
                        ...
                        straight, middle-class, able-bodied white women."})
    term1.insert
